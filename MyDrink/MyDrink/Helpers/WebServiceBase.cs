...
namespace MyDrink.Helpers
{
    ...
    {
        private static string BaseUrl = "https://api-alunos.herokuapp.com/";
        ...
        public static async Task<T> RequestAsync(string URL, RequestType requestType = RequestType.Get, T SendObject = null, int triesNumber = 0, string contentType = "application/json")
        {
